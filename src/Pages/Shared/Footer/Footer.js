        ...
        <section>
            <footer className="footer p-10 bg-base-300 text-base-content">
                <div>
                    ...
                    <Link className="link link-hover">Admin role</Link>
                </div> 
                <div>
                    <span className="footer-title">Brands</span> 
                    <Link className="link link-hover">BMW</Link> 
                    <Link className="link link-hover">SUJUKI</Link> 
                    <Link className="link link-hover">KTM</Link> 
                </div> 
                <div>
                ...
                <div>
                    <span className="footer-title">Social Use My page</span> 
                    ...
                    <div className="relative mt-2">
                        <input type="text" placeholder="users@site.com" className="input input-bordered w-full pr-16" /> 
